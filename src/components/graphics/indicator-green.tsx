export default function IndicatorGreen(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} width="100" height="280" viewBox="0 0 100 280" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="50" cy="130" r="20" fill="#43A047"/>
      <circle cx="50" cy="130" r="16" fill="#66BB6A" opacity="0.9"/>
      <circle cx="45" cy="125" r="6" fill="#A5D6A7" opacity="0.7"/>
