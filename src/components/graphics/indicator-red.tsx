export default function IndicatorRed(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} width="100" height="280" viewBox="0 0 100 280" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="50" cy="130" r="20" fill="#E53935"/>
      <circle cx="50" cy="130" r="16" fill="#EF5350" opacity="0.9"/>
      <circle cx="45" cy="125" r="6" fill="#FFCDD2" opacity="0.7"/>
