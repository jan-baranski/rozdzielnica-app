export default function Isolator4p63a(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} width="400" height="280" viewBox="0 0 400 280" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="200" y="90" fontFamily="Arial, sans-serif" fontSize="36" fontWeight="bold" fill="#1A1A1A" textAnchor="middle">63A</text>

      <rect x="170" y="115" width="60" height="14" rx="1" fill="#C62828"/>
      <text x="200" y="125" fontFamily="Arial, sans-serif" fontSize="9" fontWeight="bold" fill="white" textAnchor="middle">I-ON</text>

      <rect x="140" y="140" width="120" height="65" rx="3" fill="#E8E8E8" stroke="#B0B0B0" strokeWidth="1"/>
      <rect x="143" y="143" width="114" height="59" rx="2" fill="#F5F5F5"/>
      <rect x="150" y="148" width="100" height="28" rx="2" fill="#2C2C2C" stroke="#1A1A1A" strokeWidth="1"/>
      <rect x="152" y="150" width="96" height="24" rx="1" fill="#3A3A3A"/>
