export default function Mcb1pB20(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} width="100" height="280" viewBox="0 0 100 280" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      {/* Rating label */}
      <text x="50" y="90" fontFamily="Arial, sans-serif" fontSize="36" fontWeight="bold" fill="#1A1A1A" textAnchor="middle">B20</text>
