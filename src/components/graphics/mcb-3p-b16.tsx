export default function Mcb3pB16(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} width="300" height="280" viewBox="0 0 300 280" fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Main housing - 3 modules wide */}
      ...
      {/* Rating label */}
      <text x="150" y="90" fontFamily="Arial, sans-serif" fontSize="36" fontWeight="bold" fill="#1A1A1A" textAnchor="middle">B16</text>
      ...
      <rect x="133" y="143" width="34" height="59" rx="2" fill="#F5F5F5"/>
      <rect x="142" y="148" width="16" height="28" rx="2" fill="#2C2C2C" stroke="#1A1A1A" strokeWidth="1"/>
      <rect x="144" y="150" width="12" height="24" rx="1" fill="#3A3A3A"/>

      <rect x="230" y="140" width="40" height="65" rx="3" fill="#E8E8E8" stroke="#B0B0B0" strokeWidth="1"/>
      <rect x="233" y="143" width="34" height="59" rx="2" fill="#F5F5F5"/>
      <rect x="242" y="148" width="16" height="28" rx="2" fill="#2C2C2C" stroke="#1A1A1A" strokeWidth="1"/>
      <rect x="244" y="150" width="12" height="24" rx="1" fill="#3A3A3A"/>
