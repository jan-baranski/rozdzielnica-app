export default function Mcb3pC20(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} width="300" height="280" viewBox="0 0 300 280" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="150" y="90" fontFamily="Arial, sans-serif" fontSize="36" fontWeight="bold" fill="#1A1A1A" textAnchor="middle">C20</text>
