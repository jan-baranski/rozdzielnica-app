export default function Rcbo1pB16_30ma(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg {...props} width="100" height="280" viewBox="0 0 100 280" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <text x="50" y="90" fontFamily="Arial, sans-serif" fontSize="24" fontWeight="bold" fill="#1A1A1A" textAnchor="middle">B16</text>
